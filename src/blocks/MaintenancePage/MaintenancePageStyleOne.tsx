export default function MaintenancePageStyleOne() {
  return (
    <section className="break-words bg-white dark:bg-gray-800 max-sm:p-5 sm:p-10">
      <div className="flex flex-row items-center justify-between gap-5 max-lg:flex-col">
        <div className="flex flex-col  gap-5">
          <h2 className="text-8xl font-bold text-gray-800 dark:text-white max-lg:text-5xl">
            Under Maintenance
          </h2>
          <p className="text-lg">
